========================================================================
    APLICACIÓN: JUEGO_FINAL Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación JUEGO_FINAL.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación JUEGO_FINAL.
